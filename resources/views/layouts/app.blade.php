...
<head>
    ...
    <title>@yield('title', 'fzStore') - fzStore</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center gap-8">
                    <a href="{{ route('home') }}" class="text-2xl font-bold text-accent tracking-tight animate-float inline-block">
                        <span class="text-primary">f</span>zStore
                    </a>
    ...
    <footer class="bg-white border-t border-gray-100 mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 class="text-xl font-bold text-accent tracking-tight animate-float inline-block">
                        <span class="text-primary">f</span>zStore
                    </h3>
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2">
                        ...
                        <li class="text-sm text-gray-500">Email: hello@fzstore.com</li>
                        <li class="text-sm text-gray-500">Senin - Sabtu, 09:00 - 21:00</li>
                    </ul>
                </div>
            </div>
            <div class="mt-8 pt-6 border-t border-gray-100 text-center">
                <p class="text-sm text-gray-400">&copy; {{ date('Y') }} fzStore. All rights reserved.</p>
            </div>
        </div>
    </footer>

    <a href="https://wa.me/6281234567890?text=Halo%20fzStore%2C%20saya%20ingin%20bertanya!"
       target="_blank"
